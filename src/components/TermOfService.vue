        ...
        <section class="inner-page">
          <div class="container">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to App Dev Team,
                  UNLV, 4505 S. Maryland Parkway, Box 454019, Las Vegas, NV
                  89154, USA.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to App Dev Team, accessible
                  from
                  <a
                    href="https://web.cs.unlv.edu/"
            ...
            <p>
              ...
              <a href="mailto:appdev+tos@unlv.edu">appdev+tos@unlv.edu</a
              >.<br />
            </p>
          </div>
        </section>
